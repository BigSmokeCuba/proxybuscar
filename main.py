...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if '/start' in msgText:
            start_msg = '👋 Bienvenido a UploaderProxySearcher 7.2.0\nInfo: Este bot , permite buscar proxys un poco mas rapido que su version anterior\nTiempo: El bot se puede demorar de 2 a 3 horas en el peor de los casos en buscar un proxy aunque normalmente en 1 hora o menos ya le entregara su proxy👍\n Dev: @anonedev'
